...
This fork exists because, at the time of the fork, upstream seemed dead. We needed to update this
package in order to keep up with Django 1.8+ (and thus, django-tables2 1.2+).
